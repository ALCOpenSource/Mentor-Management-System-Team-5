...
const Header = (props) => {
  ...
  return (
    <section className={cx(styles.dashboardHeaderContainer)}>
      <Navbar
        expanded={expanded} expand="lg" className={cx(styles.navbarContainer, "flexRow")}
      >
        ...
        <Navbar.Brand className={cx(styles.logoDiv, "flexRow")}>
          <Link to="/"><img className={cx(styles.logo)} src={logo} alt="logo" /></Link>
          <Link to="/"><p className={cx(styles.caption)}>Mentor's Managers System</p></Link>
        </Navbar.Brand>
