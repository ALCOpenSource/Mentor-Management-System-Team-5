...
export const deleteMentorApi = async (data) => await axios.delete(`/Mentors/mentor/${data}`, data);
export const getMentorDetailsApi = async (data) => await axios.get(`/Mentors/mentor/${data}`, data);
